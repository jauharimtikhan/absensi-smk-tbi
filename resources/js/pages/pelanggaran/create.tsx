...
interface PelanggaranCreateModalProps {
    open: boolean;
    onClose: () => void;
    siswas: OptionsSelect2[];
}
type FormPelanggaranCreate = {
    siswa_id: string;
...
export default function PelanggaranCreateModal({
    open,
    onClose,
    siswas,
}: PelanggaranCreateModalProps) {
    const { data, setData, errors, processing, post, reset } =
        useForm<FormPelanggaranCreate>({
            siswa_id: "",
